        ...
        return new external_function_parameters([
            'response' => new external_multiple_structure(
                new external_single_structure([
                    ...
                    'name' => new external_value(PARAM_TEXT, 'Audio or video recorder type'),
                    'transcriber' => new external_value(PARAM_TEXT, 'Media URL'),
                    'turns' => new external_value(PARAM_TEXT, 'Media file name', VALUE_OPTIONAL),
                    'avturn' => new external_value(PARAM_TEXT, 'Source URL', VALUE_OPTIONAL),
                    'accuracy' => new external_value(PARAM_TEXT, 'Source mimetype', VALUE_OPTIONAL),
                    'chatid' => new external_value(PARAM_INT, 'Subtitling enabled', VALUE_OPTIONAL),
