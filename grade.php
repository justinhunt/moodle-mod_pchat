...
if(has_capability('mod/pchat:manageattempts',context_module::instance($cm->id))){
    // redirect to a report page
    redirect("reports.php?report=attempts&id=$id&n=$cm->instance");
