...
require_once($CFG->dirroot . '/mod/pchat/mod_form.php');
...
$mform = new \mod_pchat\setupform(null,['context'=>$modulecontext]);
...
if ($mform->is_cancelled()) {
    ...
    $itemid=0;
    $edoptions = pchat_editor_no_files_options($modulecontext);
    foreach($editors as $editor){
        $data = file_postupdate_standard_editor( $data, $editor, $edoptions,$modulecontext,constants::M_COMPONENT,$editor,$itemid);
    }
