...
/**
 * pchat module admin settings and defaults
 *
 * @package    mod
 * @subpackage pchat
...
//if we have no API user and secret we show a "fetch from elsewhere on site" or "take a free trial" link
        ...
        $cp_components=['filter_poodll','qtype_cloudpoodll','mod_readaloud','mod_wordcards','mod_solo','mod_minilesson','mod_englishcentral',
    ...
    $regions = \mod_pchat\utils::get_region_options();
    ...
    $expiredays = \mod_pchat\utils::get_expiredays_options();
