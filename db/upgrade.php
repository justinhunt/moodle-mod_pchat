...
function xmldb_pchat_upgrade($oldversion) {
    ...
    if ($oldversion < 2020082500) {
        ...
        upgrade_mod_savepoint(true, 2020082500, 'pchat');
    }
    if ($oldversion < 2021092500) {
        $table = new xmldb_table('pchat_topics');
        $field =  new xmldb_field('topiciframe', XMLDB_TYPE_TEXT, null, null, null, null, null);
    ...
    if ($oldversion < 2021111100) {
        $table = new xmldb_table('pchat');
        $field =  new xmldb_field('requireselfreview', XMLDB_TYPE_INTEGER, '2', null, XMLDB_NOTNULL, null, '0');
