...
/// Replace pchat with the name of your module and remove this line
...
$PAGE->set_url('/mod/pchat/index.php', array('id' => $id));
...
if (! $instances = get_all_instances_in_course(constants::M_MODNAME, $course)) {
    notice(get_string('nopchats', constants::M_COMPONENT), new moodle_url('/course/view.php', array('id' => $course->id)));
}
...
foreach ($instances as $moduleinstance) {
    if (!$moduleinstance->visible) {
        $link = html_writer::link(
            new moodle_url('/mod/pchat/view.php', array('id' => $moduleinstance->coursemodule)),
