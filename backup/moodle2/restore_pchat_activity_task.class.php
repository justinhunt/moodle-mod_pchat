...
require_once($CFG->dirroot . '/mod/pchat/backup/moodle2/restore_pchat_stepslib.php'); // Because it exists (must)

/**
 * pchat restore task that provides all the settings and steps to perform one
 * complete restore of the activity
 */
class restore_pchat_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_pchat_activity_structure_step('pchat_structure', 'pchat.xml'));
    }
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('PCHATVIEWBYID', '/mod/pchat/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('PCHATSEEDINDEX', '/mod/pchat/index.php?id=$1', 'course');
     ...
     * pchat, or a backup/restore of a single one. We have no way to determine which and whether this is the
